...
@interface DanceClassViewController ()<UITableViewDataSource,UITableViewDelegate>{
    AVPlayer *_player;
    UIView *_playerView;
...
@implementation DanceClassViewController
/*
- (void)dealloc{
...
-(void)setupUI{
    //创建播放器层
    _playerView =[[UIView alloc]initWithFrame:CGRectMake(0, 64, kScreenWidth, 211)];
    
    _playerView.backgroundColor = [UIColor blackColor];
    [self.view addSubview:_playerView];
    _playButton = [[UIButton alloc]initWithFrame:CGRectMake(15, _playerView.height-39, 28, 28)];
    ...
    _commentTable = [[UITableView alloc]initWithFrame:CGRectMake(0, 64+211, kScreenWidth, self.view.frame.size.height-64-211) style:UITableViewStylePlain];
    _commentTable.delegate = self;
    _commentTable.dataSource = self;
    _commentTable.separatorStyle = NO;
